...
zassxd.sendMessage(from, gfx, image, { quoted: mek, caption: '*Logo By Alwi Officia*'})
break
case 'gfx3':
case 'gfx4':
...
zassxd.sendMessage(from, asupan, video, {quoted: mek, caption: 'By Alwi Official '})
break
case 'hijaber':
sticWait(from)
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/hijaber?apikey=${dhakey}`)
zassxd.sendMessage(from, asupan, image, {quoted: mek, caption: 'By Alwi Official'})
break
case 'quotesimage':
case 'renungan':
sticWait(from)
...
zassxd.sendMessage(from, oke, image, {quoted: mek, caption: 'By Alwi Official'})
break
case 'darkjoker':
case 'darkjokes':
case 'darkjokers':
...
zassxd.sendMessage(from, buff, image, {thumbnail: Buffer.alloc(0), quoted: mek, caption: 'By Alwi Official'})
break
case 'tinyurl':
...
zassxd.sendMessage(from, nyz4, image, {thumbnail:Buffer.alloc(0), caption: 'By Alwi Official',quoted: mek})
break
case 'darkmeme':
sticWait(from)
if (isBanned)return sticBanned(from)
...
zassxd.sendMessage(from, harta, image, {quoted: mek, caption: 'By Alwi Official'})
break
...
zassxd.sendMessage(from, pornhub, image, {caption: `By Alwi Official`, quoted: mek})
break
case 'pornhub':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(8)
...
zassxd.sendMessage(from, girlneko, image, {caption: `By Alwi official`, quoted: mek})
break
case 'sadboy':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(7)
...
zassxd.sendMessage(from, bf, image, { quoted: flexx, caption: 'Logo By Alwi' })
break
case 'girlneko':
case 'sadboy':
if (isBanned)return sticBanned(from)
